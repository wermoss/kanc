...
export default defineNuxtPlugin((nuxtApp) => {
    ...
    nuxtApp.vueApp.use(createGtm({
        ...
        enabled: !!cookieControl.cookiesEnabledIds.value?.includes('gtm'), // defaults to true. Plugin can be disabled by setting this to false for Ex: enabled: !!GDPR_Cookie (optional)
