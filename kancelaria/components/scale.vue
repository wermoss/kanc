<template>
    <div class="fixed bottom-20 right-20">
      ...
      <div class="absolute bg-black h-16 w-16 rounded-full flex items-center justify-center">
            <img src="/src/phone.svg" alt="Phone" class="w-full h-full object-contain w-7 h-7"/>
        </div>    
    </div>
  </template>
  ...
  const initialOpacityDiv1 = ref(0.2) // Zmieniamy tę linię
  const initialOpacityDiv2 = ref(0.2) // Zmieniamy tę linię
